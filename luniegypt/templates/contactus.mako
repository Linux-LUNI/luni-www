        ...
        <div class="col-6 col-sm-6 col-lg-4">
          <h2>Mailing Lists</h2>
		    ...
		    <table border=0 style="padding: 5px;" cellspacing=0>
		      ...
		      Subscribe to <a href="https://groups.google.com/group/luni-chicago/">Linux Users of Northern Illinois</a>
		      </td></tr>
		      <form action="http://groups.google.com/group/luni-chicago/boxsubscribe">
		      <input type=hidden name="hl" value="en">
		      <tr><td style="padding-left: 5px;">
		      Email: <input type=text name=email>
		      <input class="btn btn-primary" type=submit name="sub" value="Subscribe">
		      </td></tr>
		    </form>
		    </table>
		    <!-- End LUNI -->
		    ...
		    <table border=0 style=" padding: 5px;" cellspacing=0>
		      <tr><td style="padding-left: 5px">
		      Subscribe to <a href="https://groups.google.com/group/luni-announce-chicago">Linux Users of Northern Illinois announce list</a>
		      </td></tr>
